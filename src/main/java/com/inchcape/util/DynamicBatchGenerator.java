...
public class DynamicBatchGenerator implements Callable {
	
	private static final String DYNAMIC_FLOW_PROPERTY_NAME = "flowName.";
	private static final String DYNAMIC_FLOW_CONFIG_FILE = "dynamic-batch-template.xml";
	...
	public Object onCall(MuleEventContext eventContext) throws Exception {
    	...
    	configs.add(DYNAMIC_FLOW_CONFIG_FILE);
    	contextName = eventContext.getMuleContext().getUniqueIdString();
    	add(contextName, configs);
    	//run(contextName, System.getProperty(DYNAMIC_FLOW_PROPERTY_NAME+commonPath), eventContext.getMessage());
